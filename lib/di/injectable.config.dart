...
import '../repository/debug/debug_repository.dart' as _i17;
import '../repository/locale/locale_repository.dart' as _i20;
import '../repository/refresh/refresh_repository.dart' as _i22;
import '../repository/secure_storage/auth/auth_storage.dart' as _i16;
import '../repository/secure_storage/secure_storage.dart' as _i14;
import '../repository/shared_prefs/local/local_storage.dart' as _i19;
import '../util/cache/cache_controller.dart' as _i4;
import '../util/cache/cache_controlling.dart' as _i3;
import '../util/interceptor/network_auth_interceptor.dart' as _i21;
...
import '../util/interceptor/network_refresh_interceptor.dart' as _i25;
import '../viewmodel/debug/debug_platform_selector_viewmodel.dart' as _i7;
import '../viewmodel/debug/debug_viewmodel.dart' as _i18;
import '../viewmodel/global/global_viewmodel.dart' as _i24;
...
import '../viewmodel/splash/splash_viewmodel.dart' as _i23;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i11.MenuBackgroundViewModel>(_i11.MenuBackgroundViewModel());
  ...
  gh.lazySingleton<_i16.AuthStorage>(
      () => _i16.AuthStorage(get<_i5.SimpleKeyValueStorage>()));
  gh.lazySingleton<_i17.DebugRepository>(
      () => _i17.DebugRepository(get<_i5.SharedPreferenceStorage>()));
  gh.factory<_i18.DebugViewModel>(
      () => _i18.DebugViewModel(get<_i17.DebugRepository>()));
  gh.lazySingleton<_i19.LocalStorage>(() => _i19.LocalStorage(
      get<_i16.AuthStorage>(), get<_i5.SharedPreferenceStorage>()));
  gh.lazySingleton<_i20.LocaleRepository>(
      () => _i20.LocaleRepository(get<_i5.SharedPreferenceStorage>()));
  gh.singleton<_i21.NetworkAuthInterceptor>(
      _i21.NetworkAuthInterceptor(get<_i16.AuthStorage>()));
  gh.lazySingleton<_i22.RefreshRepository>(
      () => _i22.RefreshRepository(get<_i16.AuthStorage>()));
  gh.factory<_i23.SplashViewModel>(
      () => _i23.SplashViewModel(get<_i19.LocalStorage>()));
  gh.singleton<_i24.GlobalViewModel>(_i24.GlobalViewModel(
      get<_i20.LocaleRepository>(),
      get<_i17.DebugRepository>(),
      get<_i19.LocalStorage>()));
  gh.singleton<_i25.NetworkRefreshInterceptor>(
      _i25.NetworkRefreshInterceptor(get<_i22.RefreshRepository>()));
  gh.lazySingleton<_i5.CombiningSmartInterceptor>(() =>
      registerModule.provideCombiningSmartInterceptor(
          get<_i13.NetworkLogInterceptor>(),
          get<_i21.NetworkAuthInterceptor>(),
          get<_i12.NetworkErrorInterceptor>(),
          get<_i25.NetworkRefreshInterceptor>()));
