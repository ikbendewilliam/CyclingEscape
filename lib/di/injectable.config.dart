...
import '../repository/tutorial/tutorial_repository.dart' as _i30;
...
import '../viewmodel/game/game_viewmodel.dart' as _i31;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i28.SettingsViewModel>(
      () => _i28.SettingsViewModel(get<_i24.LocalStorage>()));
  gh.factory<_i29.SplashViewModel>(
      () => _i29.SplashViewModel(get<_i24.LocalStorage>()));
  gh.lazySingleton<_i30.TutorialRepository>(
      () => _i30.TutorialRepository(get<_i24.LocalStorage>()));
  gh.factory<_i31.GameViewModel>(() => _i31.GameViewModel(
      get<_i30.TutorialRepository>(),
      get<_i24.LocalStorage>(),
      get<_i18.SpriteManager>()));
  gh.singleton<_i32.GlobalViewModel>(_i32.GlobalViewModel(
      get<_i25.LocaleRepository>(),
      get<_i22.DebugRepository>(),
      get<_i24.LocalStorage>()));
  gh.singleton<_i33.NetworkRefreshInterceptor>(
      _i33.NetworkRefreshInterceptor(get<_i27.RefreshRepository>()));
