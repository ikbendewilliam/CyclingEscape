...
class PauseMenu implements BaseView {
  ...
  PauseMenu(this.spriteManager, this.navigate, this.localizations);
  ...
  void render(Canvas canvas) {
    ...
    final TextSpan span = TextSpan(style: const TextStyle(color: Colors.white, fontSize: 18.0, fontFamily: 'SaranaiGame'), text: localizations.pausedTitle);
    final Offset position = Offset(screenSize!.width / 2, buttonSize * 1.4);
