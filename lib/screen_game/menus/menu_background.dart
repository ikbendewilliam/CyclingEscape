...
class MenuBackground {
  ...
  void render(Canvas canvas, Size? newScreenSize) {
    ...
    final Paint bgPaint = Paint()..color = Colors.blue[100]!;
    canvas.drawRect(Rect.fromLTRB(0, 0, screenSize!.width, screenSize!.height), bgPaint);

    final double offset = screenSize!.height / 7;
    ...
    final List<MovingObject> toDelete = [];
    ...
    objects.removeWhere(toDelete.contains);
