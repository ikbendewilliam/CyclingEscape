...
import '../viewmodel/career_finish/career_finish_viewmodel.dart' as _i50;
import '../viewmodel/career_overview/career_overview_viewmodel.dart' as _i51;
import '../viewmodel/career_reset/career_reset_viewmodel.dart' as _i41;
import '../viewmodel/career_select_riders/career_select_riders_viewmodel.dart'
    as _i42;
import '../viewmodel/career_standings/career_standings_viewmodel.dart' as _i43;
...
import '../viewmodel/game/game_viewmodel.dart' as _i45;
import '../viewmodel/global/global_viewmodel.dart' as _i46;
import '../viewmodel/information/information_viewmodel.dart' as _i10;
import '../viewmodel/license/license_viewmodel.dart' as _i11;
import '../viewmodel/main_menu/main_menu_viewmodel.dart' as _i47;
import '../viewmodel/menu_background/menu_background_viewmodel.dart' as _i12;
import '../viewmodel/results/results_viewmodel.dart' as _i49;
...
import 'injectable.dart' as _i53; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i41.CareerResetViewModel>(
      () => _i41.CareerResetViewModel(get<_i40.CareerRepository>()));
  gh.factory<_i42.CareerSelectRidersViewModel>(() =>
      _i42.CareerSelectRidersViewModel(
          get<_i38.CalendarRepository>(), get<_i34.TourRepository>()));
  gh.factory<_i43.CareerStandingsViewModel>(() => _i43.CareerStandingsViewModel(
      get<_i40.CareerRepository>(),
      get<_i38.CalendarRepository>(),
      get<_i29.NameRepository>()));
  gh.factory<_i44.ChangeCyclistNamesViewModel>(
      () => _i44.ChangeCyclistNamesViewModel(get<_i29.NameRepository>()));
  gh.factory<_i45.GameViewModel>(() => _i45.GameViewModel(
      get<_i36.TutorialRepository>(),
      get<_i27.LocalStorage>(),
      get<_i18.SpriteManager>()));
  gh.singleton<_i46.GlobalViewModel>(_i46.GlobalViewModel(
      get<_i28.LocaleRepository>(),
      get<_i25.DebugRepository>(),
      get<_i27.LocalStorage>()));
  gh.factory<_i47.MainMenuViewModel>(
      () => _i47.MainMenuViewModel(get<_i34.TourRepository>()));
  gh.singleton<_i48.NetworkRefreshInterceptor>(
      _i48.NetworkRefreshInterceptor(get<_i31.RefreshRepository>()));
  gh.factory<_i49.ResultsViewModel>(() => _i49.ResultsViewModel(
      get<_i29.NameRepository>(),
      get<_i34.TourRepository>(),
      get<_i40.CareerRepository>()));
  gh.factory<_i50.CareerFinishViewModel>(
      () => _i50.CareerFinishViewModel(get<_i40.CareerRepository>()));
  gh.factory<_i51.CareerOverviewViewModel>(() => _i51.CareerOverviewViewModel(
      get<_i40.CareerRepository>(),
      get<_i38.CalendarRepository>(),
      get<_i29.NameRepository>()));
