...
import 'package:cycling_escape/screen_game/menus/careerUpgrades.dart';
import 'package:cycling_escape/screen_game/menus/courseSelect.dart';
import 'package:cycling_escape/screen_game/menus/creditsView.dart';
import 'package:cycling_escape/screen_game/menus/helpMenu.dart';
import 'package:cycling_escape/screen_game/menus/info.dart';
import 'package:cycling_escape/screen_game/menus/mainMenu.dart';
import 'package:cycling_escape/screen_game/menus/menuBackground.dart';
import 'package:cycling_escape/screen_game/menus/pauseMenu.dart';
import 'package:cycling_escape/screen_game/menus/settingsMenu.dart';
import 'package:cycling_escape/screen_game/menus/tourInBetweenRaces.dart';
...
class GameManager with Game, ScaleDetector, TapDetector {
  ...
  void render(Canvas canvas) {
    if (loading) {
      ...
      final Offset position = Offset(currentSize!.width / 2, currentSize!.height / 2);
