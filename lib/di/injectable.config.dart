...
import '../database/cycling_escape_database.dart' as _i16;
import '../repository/debug/debug_repository.dart' as _i18;
import '../repository/locale/locale_repository.dart' as _i21;
import '../repository/refresh/refresh_repository.dart' as _i23;
import '../repository/secure_storage/auth/auth_storage.dart' as _i17;
import '../repository/secure_storage/secure_storage.dart' as _i14;
import '../repository/shared_prefs/local/local_storage.dart' as _i20;
...
import '../viewmodel/debug/debug_viewmodel.dart' as _i19;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  await gh.singletonAsync<_i15.SharedPreferences>(() => registerModule.prefs(),
      preResolve: true);
  gh.lazySingleton<_i16.CyclingEscapeDatabase>(() => registerModule
  ...
  gh.lazySingleton<_i17.AuthStorage>(
      () => _i17.AuthStorage(get<_i5.SimpleKeyValueStorage>()));
  gh.lazySingleton<_i18.DebugRepository>(
      () => _i18.DebugRepository(get<_i5.SharedPreferenceStorage>()));
  gh.factory<_i19.DebugViewModel>(
      () => _i19.DebugViewModel(get<_i18.DebugRepository>()));
  gh.lazySingleton<_i20.LocalStorage>(() => _i20.LocalStorage(
      get<_i17.AuthStorage>(), get<_i5.SharedPreferenceStorage>()));
  gh.lazySingleton<_i21.LocaleRepository>(
      () => _i21.LocaleRepository(get<_i5.SharedPreferenceStorage>()));
  gh.singleton<_i22.NetworkAuthInterceptor>(
      _i22.NetworkAuthInterceptor(get<_i17.AuthStorage>()));
  gh.lazySingleton<_i23.RefreshRepository>(
      () => _i23.RefreshRepository(get<_i17.AuthStorage>()));
  gh.factory<_i24.SplashViewModel>(
      () => _i24.SplashViewModel(get<_i20.LocalStorage>()));
  gh.singleton<_i25.GlobalViewModel>(_i25.GlobalViewModel(
      get<_i21.LocaleRepository>(),
      get<_i18.DebugRepository>(),
