...
class ActiveTour {
  ...
  static ActiveTour fromJson(Map<String, dynamic> json, SpriteManager spriteManager) {
    ActiveTour activeTour = ActiveTour(json['tour'] != null ? Tour.fromJson(json['tour']) : null, json['raceType'] != null ? RaceType.fromJson(json['raceType']) : null);
    ...
    if (json['currentResults'] != null) {
      activeTour.currentResults = Results.fromJson(json['currentResults'], existingCyclists, existingTeams, spriteManager);
    }
    if (json['teams'] != null) {
      activeTour.teams = [];
      json['teams'].forEach((j) {
        activeTour.teams!.add(Team.fromJson(j, existingCyclists, existingTeams, spriteManager));
      });
    }
    if (json['cyclists'] != null) {
      activeTour.cyclists = [];
      json['cyclists'].forEach((j) {
        activeTour.cyclists.add(Cyclist.fromJson(j, existingCyclists, existingTeams, spriteManager));
      });
    }
